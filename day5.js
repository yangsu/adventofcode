...
function containsVowels(input) {
  var vowelCount = input.split('').reduce(function(count, letter) {
...
function notNaughty(input) {
  return badLetters.every(function(bad) {
...
var results = inputs.reduce(function(memo, input) {
  var result = naughtyOrNice(input);
